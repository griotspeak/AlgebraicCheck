...
reportThat(Int.self, has: PartialOrder(relation: HomogeneousRelation<Int>(<=), equivalence: ==))
reportThat(Int.self, has: TotalOrder(relation: HomogeneousRelation<Int>(<=), equivalence: ==))
